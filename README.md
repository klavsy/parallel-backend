...
Node.js / Express API that powers **[Parallel Universe](https://github.com/kalvs/parallel)** - an AI app that generates three alternate-life "universe" cards from a person's situation and a decision they're weighing.
...
- **Development environment** - **Visual Studio Code** with the GitHub Copilot extension; AI-generated code was integrated, configured and tested here by the author.
...
In short: AI wrote most of the code; the vision, the cloud engineering and configuration, the testing/debbuging, and all the decisions were the author's.
