...
Node.js / Express API that powers **[Parallel Universe](https://github.com/YOUR-USERNAME/YOUR-FRONTEND-REPO)** — an AI app that generates three alternate-life "universe" cards from a person's situation and a decision they're weighing.
...
**Frontend repo:** `https://github.com/YOUR-USERNAME/YOUR-FRONTEND-REPO`
