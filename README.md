...
Node.js · Express · Hugging Face Inference Providers (`google/gemma-4-31B-it`, story generation) · Foundry IQ on Azure AI Search (`gpt-4.1-mini` for retrieval) · Azure AI Speech · Azure Maps · hosted on Render.
...
In short: AI wrote most of the code for server.js and JSON files; the vision, the cloud engineering and configuration, the testing/debugging and all the decisions were the author's.
